...
@ComponentScan({"evolution"})// Once this annotation is defined. Don't forget to put @Service above AnotherService. You don't need to define a bean for AnotherService in Application.
